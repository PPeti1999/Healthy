...
namespace Healthy.Server.Data.Migrations
{
    ...
    [Migration("20250312165613_AddingUserToDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Healthy.Server.Models.ActivityCatalog", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.DailyNote", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.Food", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealEntries", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealFoods", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealRecipes", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealTypes", b =>
                {
                    b.Property<string>("MealTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Healthy.Server.Models.Photo", b =>
                {
                    b.Property<string>("PhotoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Healthy.Server.Models.Recipe", b =>
                {
                    b.Property<string>("RecipeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Healthy.Server.Models.RecipeFoods", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.UserActivity", b =>
                {
            ...
            modelBuilder.Entity("Healthy.Server.Models.DailyNote", b =>
                {
                    b.HasOne("Healthy.Server.Models.User", "User")
                        .WithMany("DailyNotes")
            ...
            modelBuilder.Entity("Healthy.Server.Models.Food", b =>
                {
                    b.HasOne("Healthy.Server.Models.Photo", "Photo")
                        .WithMany("Foods")
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealEntries", b =>
                {
                    b.HasOne("Healthy.Server.Models.DailyNote", "DailyNote")
                        .WithMany("MealEntries")
                        .HasForeignKey("DailyNoteID");

                    b.HasOne("Healthy.Server.Models.MealTypes", "MealType")
                        .WithMany()
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealFoods", b =>
                {
                    b.HasOne("Healthy.Server.Models.Food", "Food")
                        .WithMany("MealFoods")
                        .HasForeignKey("FoodID");

                    b.HasOne("Healthy.Server.Models.MealEntries", "MealEntry")
                        .WithMany("MealFoods")
            ...
            modelBuilder.Entity("Healthy.Server.Models.MealRecipes", b =>
                {
                    ...
                    b.HasOne("Healthy.Server.Models.Recipe", "Recipe")
                        .WithMany("MealRecipes")
            ...
            modelBuilder.Entity("Healthy.Server.Models.UserActivity", b =>
                {
                    b.HasOne("Healthy.Server.Models.ActivityCatalog", "ActivityCatalog")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Healthy.Server.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
